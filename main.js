...
document.getElementById('q1').innerHTML += `My name is ${me.name}, I live in ${me.city} I'm a ${me.jobTitle}`;
...
var laurensChoice = invitees.adults[2].dinnerChoice;
document.getElementById('q9').innerHTML +=  "Lauren's appetizer is " + laurensChoice[0] + ", She will be eating " +  laurensChoice[1] + " for dinner and has selected " + laurensChoice[2] + " as her dessert.";
...
jsWorkshop.classmates = ["al","bert","cosmo","didgerido","ebisu"];
document.getElementById('q11').innerHTML += "Classmates = " + jsWorkshop.classmates;
// 12. Get the length of the fourth classmate's name.
document.getElementById('q12').innerHTML+= "The fourth classmates name is " + jsWorkshop.classmates[3].length + " letters long!";
// 13. Clear the classmates value.
jsWorkshop.classmates = "";
document.getElementById('q13').innerHTML+= "Classmates = " + jsWorkshop.classmates;
